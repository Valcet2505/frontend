            ...
            {!isAuthenticated ? (
              <>
                <button
                  ...
                  className="border border-white text-white hover:bg-[#CAF0F8] hover:text-[#03045E] transition-all duration-200 px-4 py-2 rounded-md text-sm font-medium mr-2"
                >
                  Ingresa
                </button>
                <button
                  onClick={() => navigate('/register')}
                  className="border border-white text-white hover:bg-[#CAF0F8] hover:text-[#03045E] transition-all duration-200 px-4 py-2 rounded-md text-sm font-medium"
                >
                  Registrarse
                </button>
              </>
